    ...
    Node $computername
    {
        ...
        Script imagecleanup
        {
            SetScript = {
				...
				#Restart-Service -Name WinRM -confirm:$false -Force
                ...
                Copy-Item -Path "C:\fidelity\Scripts\Sysprep.bat" -Destination "C:\Windows\System32\Sysprep\" -Force -PassThru
            ...
            TestScript = { 
                If (Test-Path -path $env:SystemDrive\Windows\System32\Sysprep\Unattend.xml) {
